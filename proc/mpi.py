...
def run_on_main_rank(func, *args, **kwargs):
    ...
    if is_main_rank:
        ...
        # https://urldefense.com/v3/__https://stackoverflow.com/questions/29170492/mpi4py-substantial-slowdown-by-idle-cores__;!!Nmw4Hv0!jLXMiuEklQW-yqLDPJW5rm55boiFjHojFgVDXaTO6rGVA-Pc9C-crxM041m4mxNbquxOm4KPAXjkZqo$ 
        import time
